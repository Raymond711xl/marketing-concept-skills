...
- How does this tension relate to the brand's strongest truth?
- Can the brand credibly help resolve or reframe it?
...
Choose one recommended direction when the input package is sufficient. If brand
facts or competitor difference are weak, recommend a provisional direction and
name the rollback path needed before final approval. Include what must be
validated before execution.

## Rollback Paths

Use these when the strategy cannot be finalized:
...
Level 4 should leave the reader thinking: "This is the strategic choice, and it
is grounded in evidence rather than taste."
